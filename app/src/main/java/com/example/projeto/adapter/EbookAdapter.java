...
import com.example.projeto.model.Ebook;

import java.util.ArrayList;
Ebook
public class EbookAdapter extends RecyclerView.Adapter<EbookAdapter.EbookViewHolder> {
    private final ArrayList<Ebook>ebookList;
    private final Context context;

    public EbookAdapter(ArrayList<Ebook> ebookList, Context context) {
    ...
    public void onBindViewHolder(@NonNull EbookViewHolder holder, int position) {
        ...
        holder.binding.txtEbookDescription.setText(ebookList.get(position).getEbookDescription());
